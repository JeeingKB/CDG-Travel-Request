...
import { Loader2, ShieldCheck, LayoutDashboard, Database, Globe } from 'lucide-react';
...
export const LoginPage: React.FC = () => {
  ...
  const handleAzureLogin = async () => {
      ...
      // If error or no redirect happens quickly
        ...
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-2xl w-full max-w-md relative z-10 border border-slate-100">
            ...
            <div className="space-y-4">
                ...
                >
                    ...
                    <span>{isRedirecting ? 'Redirecting to Microsoft...' : 'Sign in with Microsoft'}</span>
                </button>
                ...
                <div className="relative my-8">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                        <span className="bg-white px-2 text-slate-400 font-bold tracking-wider">Or Demo Access</span>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                    ...
                    <button 
                        ...
                        className="p-3 border border-slate-200 rounded-xl hover:bg-slate-50 hover:border-purple-300 transition-all flex flex-col items-center gap-1 col-span-2 group"
                    >
                        <LayoutDashboard size={20} className="text-slate-400 group-hover:text-purple-600"/>
                        <span className="text-xs font-bold text-slate-600">ADS (Admin)</span>
                    </button>
                </div>
            </div>
